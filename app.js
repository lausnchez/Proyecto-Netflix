      ...
      <div class="movie-card-content">
        ...
        <div class="movie-card-bottom">
          <div class="movie-card-buttons">
            <button class="card-btn-play" onclick="playMovie(${JSON.stringify(movie).replace(/"/g, '&quot;')})">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M8 5v14l11-7z"/>
              </svg>
              Play
            </button>
            <button class="card-btn-icon" onclick="addToList(${movie.id})">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <line x1="12" y1="5" x2="12" y2="19"></line>
                <line x1="5" y1="12" x2="19" y2="12"></line>
              </svg>
            </button>
            <button class="card-btn-icon" onclick="showDetails(${JSON.stringify(movie).replace(/"/g, '&quot;')})">
